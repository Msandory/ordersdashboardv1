  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "grid grid-cols-7", // Use grid instead of flex to align days correctly
        head_cell:
          "text-muted-foreground rounded-md text-center font-normal text-[0.8rem] p-2", // Center text and make sure each cell has equal width
        row: "grid grid-cols-7 gap-1", // Ensure rows also use grid with 7 columns
